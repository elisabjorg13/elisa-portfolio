...
export default function CVPage() {
    return (
        <div id="cv-root" className="w-screen h-screen bg-white relative overflow-hidden">
            <div className="w-full h-full flex flex-col p-4 md:p-6 gap-6 md:gap-10 text-black overflow-y-auto">
                <div className="w-full flex flex-row gap-6 md:gap-12">
                    <Image src="/images/elisaCV.jpg" alt="Elisa" width={100} height={70} className="w-16 h-17 md:w-24 md:h-25" />
                    <p className='text-xs md:text-sm'>Elísa Björg Tryggvadóttir</p>
                </div>
                <div className='grid grid-cols-2 gap-4 md:gap-6 md:flex md:flex-row md:justify-between text-xs'>
                    <div className='flex flex-col gap-6 md:flex-row md:gap-12 md:w-auto'>
